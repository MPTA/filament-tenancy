...
class FilterAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $this->label(__('filament::pages/dashboard.actions.filter.label'));

        $this->modalHeading(fn (): string => __('filament::pages/dashboard.actions.filter.modal.heading'));

        $this->modalSubmitActionLabel(__('filament::pages/dashboard.actions.filter.modal.actions.apply.label'));
