...
return new class extends Migration
{
    ...
    {
        Schema::create('quotation_offer_group_companion_attraction_costs', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('quotation_offer_group_companion_attraction_costs');
    }
};
