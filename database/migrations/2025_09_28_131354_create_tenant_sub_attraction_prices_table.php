...
return new class extends Migration
{
    ...
    {
        Schema::create('tenant_sub_attraction_prices', function (Blueprint $table) {
            ...
            // Unique constraint - هر تننت فقط یک قیمت برای هر ساب اترکشن داشته باشد
    ...
    {
        Schema::dropIfExists('tenant_sub_attraction_prices');
    }
};